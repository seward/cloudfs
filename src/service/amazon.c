...
const char *amazon_key = NULL, *amazon_secret = NULL, *amazon_location = NULL;
...
void curdate(char *str, int32_t size) {
	static const char *lookup_week[7] = { "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" },
			  *lookup_month[12] = { "Jan",  "Feb", "Mar",  "Apr",  "May",  "Jun",
...
static void base64_encode(const char *in_str, uint32_t in_len, char **out_str, uint32_t *out_len) {
